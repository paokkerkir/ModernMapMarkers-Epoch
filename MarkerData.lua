...
--    {"Ashenvale", 0.937, 0.355, "Emerald Dragon\n|cFF808080(Bough Shadow)|r", "worldboss", "60", nil},
  --  {"Feralas", 0.512, 0.108, "Emerald Dragon\n|cFF808080(Dream Bough)|r", "worldboss", "60", nil},
    ...
    -- -------------------------------------------------------------------------
    -- Dungeons
    -- TODO: replace "TolBarad" with real GetMapInfo() zone name once confirmed
    {"Arathi", 0.322, 0.824, "Flight Path to Tol Barad", "flightpath", "Neutral", nil, "TolBarad"},
    -- TODO: confirm zone name and set real x/y coords for entrance pin
    {"TolBarad", 0.5, 0.5, "Baradin Hold", "dungeon", "57-60", "BaradinHold"},
